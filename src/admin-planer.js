  ...
  if (p === '/planners' && m === 'GET') {
    ...
    return json({
      ...
      features: [
        ...
        { id: 'xlsx', label: 'خواندن از اکسل', note: 'یک‌بار فایل را می‌خواند و داخل کارتابل می‌نشاند — بعدش دیگر به فایل کاری ندارد' },
        { id: 'folder', label: 'آینهٔ اکسل روی سیستم', note: 'اتصال همیشگی به پوشهٔ مشترک — با «خواندن از اکسل» فرق دارد' }
      ],
