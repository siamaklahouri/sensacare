  ...
  async fetch(req, env, ctx) {
    ...
    try {
      ...
      if (p === '/api/sl/contact' && m === 'POST') {
        ...
        /* «-» یا «—» هم عملاً خالی است: مدیر بعداً پیام را می‌بیند و راهی
           برای جواب دادن ندارد. پس همین‌جا جلویش گرفته می‌شود. */
        if (!/[\p{L}\p{N}]/u.test(contact))
          return bad('یک راهِ تماس بنویسید، وگرنه جوابی نمی‌شود داد.');
